...
export default function LabSection() {
  ...
  return (
    <section id="lab" className="relative max-w-[1400px] mx-auto px-6 md:px-12 py-16 md:py-24 border-t border-[#eeeeee]">
      <div className="flex flex-col xl:flex-row items-start gap-12 lg:gap-14 mb-16">
        {/* Left column */}
